...
[ CAPS ] = KEYMAP( //Mostly mouse layer with option for caps too
        _______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7,KC_F8, KC_F9,KC_F10,KC_F11, KC_F12, DELE, DELE,\
        _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, HOME   ,   KC_UP, ENDI, PGUP, _______, _______, _______,\
        _______, _______, VOLD, VOLU, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, PGDN, _______, _______, _______,\
        KC_LSPO, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, XXXXX,\
        KC_LCTL, KC_LGUI, KC_LALT,           _______,             _______, _______, _______, _______),


[ FN1 ] = KEYMAP( //Functions/settings
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,\
        KC_RTOG,KC_RMOD,KC_RHUI,KC_RSAI,KC_RVAI,  _______, _______, _______, _______, _______, _______, _______, _______, _______,\
